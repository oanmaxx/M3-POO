...
public class ClientCard {
    private String id, CNP, firstName, LastName, dateOfBirth, dateOfRegistration;

    public ClientCard(String id, String CNP, String firstName, String lastName, String dateOfBirth, String dateOfRegistration) {
        this.id = id;
        this.CNP = CNP;
