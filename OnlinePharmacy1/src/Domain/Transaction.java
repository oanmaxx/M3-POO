...
public class Transaction {
    private int id, idMedicament, idClientCard;
    private String date, time;
    private int numberOfItems;
    private double basePrice;
    private double discount;

    public Transaction(int id, int idMedicament, int idClientCard, String date, String time, int numberOfItems, double basePrice, double discount) {
        this.id = id;
